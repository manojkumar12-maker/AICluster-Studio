...
Welcome to AICluster v1.3.1. This documentation will guide you through installing, configuring, and operating AICluster.
...
| [UPGRADING.md](UPGRADING.md) | Upgrading from v1.3.0 | You're upgrading an existing installation |
...
```
          ...
          └────────┬────────┘      └────────┬────────┘
                   ...
                   ▼                        ▼
          ┌─────────────────┐      ┌─────────────────┐
          │  QUICK_START.md  │      │  UPGRADING.md   │
          └────────┬────────┘      └────────┬────────┘
                   │                        │
                   ▼                        ▼
          ┌─────────────────┐      ┌─────────────────┐
          │ FIRST_CLUSTER.md │      │  Verification   │
          └────────┬────────┘      └─────────────────┘
                   │
                   ▼
          ┌─────────────────┐
...
| `UPGRADING.md` | v1.3.0 to v1.3.1 upgrade guide | 20 KB |
